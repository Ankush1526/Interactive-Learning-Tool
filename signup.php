    ...
    <style>
        ...
        * {
        ...
        .contact-form input[type=password] {
            border: none;
            border-bottom: 1px solid #a08d8d;
        ...
        * {
        ...
        body {
            background-image: url(Utilities/wallpaperflare.com_wallpaper\ \(1\).jpg);
            background-size: cover;
        ...
        .sub {
            ...
            border: none;
            width: 90%;
            background: rgb(11, 136, 194);
            cursor: pointer;
        }

        .sub:hover {
            background: rgb(36, 149, 177);
        }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="login.html">LOGIN AND SIGNUP</a>
                    </li>

                </ul>
                <form class="d-flex" role="search">
                    <input class="form-control me-2" type="search" placeholder="Search here" aria-label="Search"
                        style="border-top-left-radius: 15%; border-bottom-right-radius: 15%; background-color:  rgb(6, 6, 6); color: rgb(205, 178, 178); font-size: 100%;box-shadow: 10%;">
...
<body> -->
    <div class="contact-form" style="height: 100%;  margin-top: 10%;">
        <img alt="" class="avatar" src="https://i.postimg.cc/zDyt7KCv/a1.jpg">
        <h2 style="margin-top: 0%;">Contact Form</h2>
        <!-- <form action="index.html" method="post" > -->

        <!--         
            <p>username</p><input placeholder="Enter username" type="username" id="username">
            <p>Passwrod</p><input placeholder="Enter Password" type="password" id="password">
